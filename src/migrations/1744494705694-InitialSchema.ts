...
export class InitialSchema1744494705694 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscription_status_enum" AS ENUM('active', 'trial', 'cancelled', 'expired')`);
        await queryRunner.query(`CREATE TYPE "public"."billing_frequency_enum" AS ENUM('monthly', 'yearly')`);
        await queryRunner.query(`CREATE TYPE "public"."plan_name_enum" AS ENUM('FREE', 'BASIC', 'PROFESSIONAL', 'BUSINESS', 'ENTERPRISE')`);
        await queryRunner.query(`CREATE TYPE "public"."redirect_type_enum" AS ENUM('301', '302')`);
        ...
        await queryRunner.query(`
            CREATE TABLE "user_subscriptions" (
                ...
                CONSTRAINT "fk_user_subscriptions_plan" FOREIGN KEY ("planId") REFERENCES "plans"("id")
            )
        `);
        ...
        await queryRunner.query(`
            CREATE TABLE "links" (
                ...
                "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "fk_links_user" FOREIGN KEY ("userId") REFERENCES "users"("id")
            )
        `);
        ...
        await queryRunner.query(`
            CREATE TABLE "click_events" (
                ...
                CONSTRAINT "fk_click_events_link" FOREIGN KEY ("linkId") REFERENCES "links"("id")
            )
        `);
        ...
        await queryRunner.query(`
            CREATE TABLE "qr_codes" (
                ...
                "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "fk_qr_codes_link" FOREIGN KEY ("linkId") REFERENCES "links"("id"),
                CONSTRAINT "fk_qr_codes_user" FOREIGN KEY ("userId") REFERENCES "users"("id")
            )
        `);
        ...
        await queryRunner.query(`
            CREATE TABLE "dynamic_links" (
                ...
                "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "fk_dynamic_links_user" FOREIGN KEY ("userId") REFERENCES "users"("id")
            )
        `);
        ...
        await queryRunner.query(`
            CREATE TABLE "dynamic_link_click_events" (
                ...
                "utmContent" varchar,
                "timestamp" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "fk_dynamic_link_click_events_dynamic_link" FOREIGN KEY ("dynamicLinkId") REFERENCES "dynamic_links"("id")
            )
        `);
        ...
        await queryRunner.query(`
            CREATE TABLE "webhook_endpoints" (
                ...
                "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
                "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "fk_webhook_endpoints_user" FOREIGN KEY ("userId") REFERENCES "users"("id")
            )
        `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "fk_users_active_subscription"`);
        ...
        // Drop enum types
        await queryRunner.query(`DROP TYPE "public"."redirect_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."plan_name_enum"`);
        await queryRunner.query(`DROP TYPE "public"."billing_frequency_enum"`);
